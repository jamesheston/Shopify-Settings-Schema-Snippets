...
Just type `ngs` and an autocomplete dropdown will appear. Depending on your Sublime Text settings, hitting `control` + `spacebar` may be necessary to open dropdown menu. The scope for this dropdown is limited to `.json` files.
